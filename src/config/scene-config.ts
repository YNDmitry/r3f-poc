export const CONSTANTS = {
  layout: {
    ...
    stagePos: {
      ...
      tablet: [0, -0.75, 0] as [number, number, number],
  ...
  grid: {
    a: { 
      ...
      tablet: { pos: [-0.6, 0, 0], scale: 0.9, rot: [0, -0.6, 0] },
  ...
  focus: {
    desktop: {
      target: { pos: [0, 0, 0] as [number, number, number], scale: 1, rot: [0, 0, 0] as [number, number, number] },
      background: { pos: [0, 0, -1] as [number, number, number], scale: 0.8, rot: [0, 0, 0] as [number, number, number] },
    },
    tablet: {
      target: { pos: [0, -0.4, 0] as [number, number, number], scale: 1.1, rot: [0, 0, 0] as [number, number, number] },
      background: { pos: [0, 0, -1] as [number, number, number], scale: 0.7, rot: [0, 0, 0] as [number, number, number] },
    },
    mobile: {
      target: { pos: [0, -1.3, 0] as [number, number, number], scale: 1.5, rot: [0, 0, 0] as [number, number, number] },
      background: { pos: [0, 0, -1.5] as [number, number, number], scale: 0.6, rot: [0, 0, 0] as [number, number, number] },
    }
  },
  customHotspots: {
    a: [
      { id: 'a1', label: 'Right Speaker', position: [0.2, 1.68, 0.15] },
      { id: 'a2', label: 'Left Speaker', position: [-0.2, 1.68, 0.15] },
      { id: 'a3', label: 'FullHD touch display', position: [0, 1.4, 0.15] },
